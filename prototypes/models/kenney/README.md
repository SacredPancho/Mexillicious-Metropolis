...
`prototypes/models.js` is generated from this folder by `tools/pack-models.py` and embeds
every file as a data URI, so `metropolis-3d.html` can load them when opened straight from
disk. Re-run the tool after adding or replacing a model here.
